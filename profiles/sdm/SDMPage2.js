...
'use strict';
  ...
  SDMPage2.prototype.decode = function(broadcast) {
    ...
    switch (this.status.SDMLocation) {
      case 0x00:
        this.status.SDMLocationFriendly = "Laces";
        break;
      case 0x01:
        this.status.SDMLocationFriendly = "Midsole";
        break;
      case 0x02:
        this.status.SDMLocationFriendly = "Other";
        break;
      case 0x03:
        this.status.SDMLocationFriendly = "Ankle";
        break;
      default:
        this.status.SDMLocationFriendly = "? " + this.status.SDMLocation;
        break;
    }

    switch (this.status.BatteryStatus) {
      case 0x00:
        this.status.BatteryStatusFriendly = "New";
        break;
      case 0x01:
        this.status.BatteryStatusFriendly = "Good";
        break;
      case 0x02:
        this.status.BatteryStatusFriendly = "OK";
        break;
      case 0x03:
        this.status.BatteryStatusFriendly = "Low battery";
        break;
      default:
        this.status.BatteryStatusFriendly = "? " + this.status.BatteryStatus;
        break;
    }

    switch (this.status.SDMHealth) {
      case 0x00:
        this.status.SDMHealthFriendly = "OK";
        break;
      case 0x01:
        this.status.SDMHealthFriendly = "Error";
        break;
      case 0x02:
        this.status.SDMHealthFriendly = "Warning";
        break;
      case 0x03:
        this.status.SDMHealthFriendly = "Reserved";
        break;
      default:
        this.status.SDMHealthFriendly = "? " + this.status.SDMHealth;
        break;
    }

    switch (this.status.UseState) {
      case 0x00:
        this.status.UseStateFriendly = "IN-ACTIVE";
        break;
      case 0x01:
        this.status.UseStateFriendly = "ACTIVE";
        break;
      case 0x02:
        this.status.UseStateFriendly = "Reserved";
        break;
      case 0x03:
        this.status.UseStateFriendly = "Reserved";
        break;
