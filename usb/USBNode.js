...
define(function (require, exports, module) {
  ...
  var USBDevice = require('./USBDevice.js'),
    ...
    //  this.addListener(USBDevice.prototype.EVENT.LOG, this.showLogMessage);
    //  this.addListener(USBDevice.prototype.EVENT.ERROR, this.showLogMessage);
  ...
  {
    var knownANTdevices = this.getKnownANTDevices();
    ...
    function filterANTdevices(usbDevice,index,arr)
    {
     ...
     return usb.getDeviceList().filter(filterANTdevices);
  };
