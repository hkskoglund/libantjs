...
define(function (require, exports, module) {
  ...
  // Standard message :  bSYNC bLENGTH bID bCHANNELNUMBER CONTENT (8 bytes) bCRC
  ...
  Message.prototype.mainParse = function (data)
  {
      //        if (data.byteOfset !== 0)
  ...
  */
  ...
  //Message.prototype.getPadZeroBuffer = function (size) {
  //
  ...
  //};
  //
  //Message.prototype.toBuffer = Message.prototype.getBuffer;
  ...
  Message.prototype.toString = function () {
      return this.name + " ID 0x" + this.id.toString(16)+' '+Message.prototype.MESSAGE[this.id];
  };
